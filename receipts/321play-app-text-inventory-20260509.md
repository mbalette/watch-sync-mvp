# 321Play / Watch Sync App Text Inventory

Generated by Jackie on 2026-05-09 12:34:50 CDT from local source in `/Users/home/Desktop/kyrosworkspace/projects/watch-sync-mvp`.

Scope: user-facing static text and dynamic status templates found in `src/App.tsx`, `src/tv-remote-device.ts`, `src/recommendations.ts`, and `src/domain.ts`. This is source-grounded, not a live deployed copy audit.
