...
export const TV_REMOTE_TARGETS: TvRemoteTargetSpec[] = [
  ...
  },
  {
    ...
    nativeFeasible: 'no',
    localHelperFeasible: 'yes',
    exactProtocol: 'adb shell input keyevent KEYCODE_MEDIA_PLAY or keycode 126; Fire TV may use KEYCODE_MEDIA_PLAY_PAUSE/85.',
    commands: [
      { id: 'adb-play', label: 'ADB media play', command: 'adb shell input keyevent KEYCODE_MEDIA_PLAY', goSafe: true, notes: 'Advanced technical-user helper only.' },
      { id: 'adb-toggle', label: 'ADB play/pause toggle', command: 'adb shell input keyevent 85', riskyToggle: true, notes: 'Avoid for GO because duplicate toggles can pause instead of play.' },
    ],
